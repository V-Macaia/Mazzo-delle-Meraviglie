...
async function rimuoviCarta(){
    ...
    if(!rimossa){
     ...
     // Suono di carta strappata

       let suonoStrappo = new Audio(
           "suoni/strappo.mp3"
       );

       suonoStrappo.volume = 0.8;
...
function aggiornaCronologia(){
    ...
    campagnaAttuale.mazzo.cartePescate.forEach(
        ...
        carta => {
            ...
            elemento.classList.add("cartaCronologia");
            ...
            nome.textContent = carta;

            nome.classList.add("nomeCartaCronologia");
            ...
            // Effetto della carta
              let effetto = null;
                ...
                effetto = document.createElement("div");

                effetto.classList.add("effettoCartaCronologia");

              let datiCarta = ottieniCarta(carta);

                if(datiCarta){

                effetto.textContent = datiCarta.effetto;

                }

                effetto.style.display = "none";

             }


            // Il click funziona SOLO in modalità Master

              if(modalitaMaster){

    nome.addEventListener("click", function(){

        if(effetto.style.display === "none"){

            effetto.style.display = "block";
...
if(modalitaMaster && effetto){

    elemento.appendChild(effetto);
...
function mostraEffettoCarta(nomeCarta){
...
function entraMaster(){
     ...
     if(password === PASSWORD_MASTER){
         ...
         let suonoDado = new Audio("suoni/dado.mp3");
         suonoDado.volume = 0.8;
         suonoDado.play();
